  ...
  <div class="modal_fondo fondo1">
    <div class="modal">
      ...
      <div class="modal_mensaje mensaje1">
        <p>A mediados del 2022, me sumergí en el maravilloso mundo de la Programación Web, considerándome actualmente un desarrollador junior en constante crecimiento</p>
    ...
    <div class="modal">
      ...
      <div class="modal_mensaje mensaje2">
        <p><i><u>DESARROLLADOR DE PÁGINAS WEB</u></i>
          ...
          <br>- HTML5, CSS3, JavaScript, React.Js
          <br>- PHP, WordPress, MySQL
          <br>- Docker - Devilbox
          <br>- Linux - Ubuntu
          <br>- Git y Github.
        </p>
    ...
    <div class="modal">
      ...
      <div class="modal_mensaje mensaje3">
        ...
        <p><i><u>UNIVERSIDAD DE BUENOS AIRES (UBA)</u></i>
          <br>• Actuario en Economía, (2016-Actual)
...
-->
        <div class="linkedin">
          <a href="https://www.linkedin.com/in/rodrigo234/" target="_blank">
